...
A single class serves the hosted (``api.openai.com``), Aval AI, DeepSeek,
Groq, Mistral, Together AI, OpenRouter, and BYOK routes: the base URL and
the API key come from the environment or constructor arguments. The class
also serves local servers through the same OpenAI-compatible protocol.
