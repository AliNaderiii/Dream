...
| Rust | `apps/desktop/src-tauri/src/bridge/process.rs` | supervisor loop, heartbeat, reader loop, writer signal, `SupervisorTiming` (heartbeat interval/timeout, backoff list — production defaults unchanged), `SupervisorControl`; 10 new tests |
